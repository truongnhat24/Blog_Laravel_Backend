...
<div class="container add-blog">
    ...
    <form enctype="multipart/form-data" action="{{ route('blogs.addBlog') }}" method="POST">
        @csrf
        <div class="row flex-row mb-3">
            ...
            <div>
                <input type="text" id="blog-title" placeholder="Ex: title..." name="title" class="form-control p-1 col-10">
            </div>
        </div>
        <div class="row flex-row mb-3">
            <div class="col-2">
        ...
        <div class="row flex-row mb-3">
            ...
            <div>
                <textarea name="content" id="blog-content" cols="30" rows="10"></textarea>
            </div>
        </div>
        <div class="row text-center">
            <div>
                <button type="submit" class="btn btn-warning" name="submit-btn">Create</button>
            </div>
        </div>
    </form>
</div>
